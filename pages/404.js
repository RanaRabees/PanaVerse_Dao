  ...
  return (
    <div className={styles.aboutpagecontainer}>
      ...
      <footer className={styles.mynav}>
        ...
        >
          {"  "}
          <img src="https://panaverse-by-ahmed.vercel.app/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FLogo.92f20aff.png&w=128&q=75" alt="RanaVerse" className={styles.navlogo} />
        </a>
        <br />
      ...
      <main className={styles.notpagecontainer}>
        ...
        <p className={styles.description}>
          Rana <code>Muhammad </code>Reebaal <code>Hussain</code>
        </p>
        ...
        <div className={styles.mythirteen}>
          ...
          <h4>
            ...
            <p className={styles.aboutpara}>
              <h1>404</h1>  The page you are looking for might
              <br /> have been removed had its name changed
              <br /> temporarily unavailable Please Main Page With Button Below
              .
              <br /><br />
              <button className={styles.mainbtn}>
      ...
      <footer>
                  ...
                  >
                    <Image
                      src="https://github.com/RanaRabees/Muslim_Political_Leaders/blob/main/public/favicon.png?raw=true"
                      alt="RanaVerse"
                      height={80}
                      width={80}
                      priority
      ...
      <style jsx>{`
        ...
        .mainbtn{
          ...
          align-items: center;
          background-image: linear-gradient(to left ,  yellowgreen , purple , pink );
          border-radius: 15%;
        }
        main {
          padding: 5rem 0;
